...
namespace Lykegenes\LocaleSwitcher\Resources;

/**
 * This trait contains a static array of all locales and their names.
 * It was taken from : https://gist.github.com/pjc-is/49971b36db38fdeae6fc
 * And it's origin is from iOS 9 beta 4 Locale Identifiers.
 * It should be sufficiently complete...
 */
trait LocalesList
{
    /**
     * This array contains all locales and their language name and region in the following format.
     * The key follows the IETF language tag format (ISO 639), and the value is human-readable.
     * KEY : {locale}-{region}
     * VALUE : {Language name} ( {Region} )
     *
     * @var array
     */
    protected static $localesList = array(
        'af' => 'Afrikaans',
